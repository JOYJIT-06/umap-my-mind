...
"""Generates a plain-English, chapter-by-chapter guide explaining all figures and results."""
import os

markdown_content = """# Mouse Brain Single-Cell Analysis: A Non-Technical Guide
...
with open("results/RESULTS_EXPLAINED.md", "w") as f:
    f.write(markdown_content)

print("Narrative guide successfully written to results/RESULTS_EXPLAINED.md")